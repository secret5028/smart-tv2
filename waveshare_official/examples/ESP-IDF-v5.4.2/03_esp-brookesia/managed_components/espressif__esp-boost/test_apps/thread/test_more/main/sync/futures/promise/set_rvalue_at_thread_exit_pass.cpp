...
static boost::promise<boost::csbl::unique_ptr<int> > p;
static boost::promise<boost::csbl::unique_ptr<int> > p2;
static void func()
{
...
BOOST_AUTO_TEST_CASE(sync/futures/promise, set_rvalue_at_thread_exit_pass)
{
    common_init();
    std::thread([&]() {
