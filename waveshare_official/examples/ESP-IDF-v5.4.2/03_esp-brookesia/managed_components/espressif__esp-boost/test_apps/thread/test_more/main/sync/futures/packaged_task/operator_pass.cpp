...
static void func1(boost::packaged_task<BOOST_THREAD_DETAIL_SIGNATURE_2> p)
{
  boost::this_thread::sleep_for(boost::chrono::milliseconds(500));
#if defined BOOST_THREAD_PROVIDES_SIGNATURE_PACKAGED_TASK && defined(BOOST_THREAD_PROVIDES_VARIADIC_THREAD)
  p(3, 'z');
...
static void func2(boost::packaged_task<BOOST_THREAD_DETAIL_SIGNATURE_2> p)
{
#if defined BOOST_THREAD_PROVIDES_SIGNATURE_PACKAGED_TASK && defined(BOOST_THREAD_PROVIDES_VARIADIC_THREAD)
  p(3, 'a');
#else
...
static void func3(boost::packaged_task<BOOST_THREAD_DETAIL_SIGNATURE_2> p)
{
  try
  {
#if defined BOOST_THREAD_PROVIDES_SIGNATURE_PACKAGED_TASK && defined(BOOST_THREAD_PROVIDES_VARIADIC_THREAD)
...
BOOST_AUTO_TEST_CASE(sync/futures/packaged_task, operator_pass)
{
    common_init();
    std::thread([&]() {
