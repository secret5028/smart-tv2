...
static boost::once_flag flg0 BOOST_INIT_ONCE_INIT;
...
static boost::once_flag flg3 BOOST_INIT_ONCE_INIT;
...
static boost::once_flag flg1 BOOST_INIT_ONCE_INIT;
...
static boost::once_flag flg2 BOOST_INIT_ONCE_INIT;
...
static boost::once_flag flg41 BOOST_INIT_ONCE_INIT;
static boost::once_flag flg42 BOOST_INIT_ONCE_INIT;
...
BOOST_AUTO_TEST_CASE(sync/mutual_exclusion/once/call_once, call_once_pass)
{
    common_init();
    std::thread([&]() {
