...
static void func_with_3_arg(Boo&& boo_1, Boo&& boo_2, Boo&& boo_3) {
...
BOOST_AUTO_TEST_CASE(sync/mutual_exclusion/with_lock_guard, with_lock_guard_move)
{
    common_init();
    std::thread([&]() {
