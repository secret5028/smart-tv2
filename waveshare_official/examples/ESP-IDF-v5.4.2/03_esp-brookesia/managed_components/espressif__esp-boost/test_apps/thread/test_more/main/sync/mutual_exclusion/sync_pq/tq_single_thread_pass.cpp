...
static void func(steady_clock::time_point pushed, steady_clock::duration dur)
{
...
BOOST_AUTO_TEST_CASE(sync/mutual_exclusion/sync_pq, tq_single_thread_pass)
{
    common_init();
    std::thread([&]() {
