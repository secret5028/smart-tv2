...
static void run_no_exception_wait()
{
  std::string s("test");
  bool parent_flag = false;
...
static void run_nested_exception()
{
  std::string s("test");
  bool parent_flag = false;
  bool task1_flag = false;
...
BOOST_AUTO_TEST_CASE(experimental/parallel/v2, task_region_pass)
{
    common_init();
    std::thread([&]() {
