...
BOOST_AUTO_TEST_CASE(topo-sort-with-sgb)
{
    TEST_ASSERT(test_main() == 0);
    /* esp32: test fails to compile due to its requirement of the Stanford GraphBase */
    std::cout << std::endl;
    std::cout << "!!! THIS TEST IS SKIPPED DUE TO ITS REQUIREMENT OF THE Stanford GraphBase. !!!" << std::endl;
    std::cout << std::endl;
}
