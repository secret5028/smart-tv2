...
internal_version_file = 'src/esp_boost_versions.h'
include_files = [
]
internal_version_macros = [
    {
        ...
        'macro': {
            'major': 'ESP_BOOST_VERSION_MAJOR',
            'minor': 'ESP_BOOST_VERSION_MINOR',
            'patch': 'ESP_BOOST_VERSION_PATCH'
        },
    },
    {
        'file': 'esp_boost_versions.h',
        'macro': {
            'major': 'ESP_BOOST_VERSION_MAJOR',
            'minor': 'ESP_BOOST_VERSION_MINOR',
            'patch': 'ESP_BOOST_VERSION_PATCH'
